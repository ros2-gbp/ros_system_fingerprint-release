## system_fingerprint (rolling) - 0.7.0-1

The packages in the `system_fingerprint` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling system_fingerprint -y` on `Thu, 13 Oct 2022 17:50:38 -0000`
...
## system_fingerprint (foxy) - 0.7.0-1

The packages in the `system_fingerprint` repository were released into the `foxy` distro by running `/usr/bin/bloom-release -r foxy system_fingerprint -y` on `Thu, 13 Oct 2022 17:32:16 -0000`
...
## system_fingerprint (foxy) - 0.6.0-1

The packages in the `system_fingerprint` repository were released into the `foxy` distro by running `/usr/bin/bloom-release -r foxy system_fingerprint -y` on `Thu, 13 Oct 2022 17:30:50 -0000`
...
## system_fingerprint (noetic) - 0.6.1-1

The packages in the `system_fingerprint` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic system_fingerprint -y` on `Thu, 13 Oct 2022 17:29:47 -0000`
...
## ros_system_fingerprint (noetic) - 0.6.0-1

The packages in the `ros_system_fingerprint` repository were released into the `noetic` distro by running `/usr/bin/bloom-release ros_system_fingerprint -r noetic` on `Thu, 22 Sep 2022 17:43:01 -0000`
...
## system_fingerprint (humble) - 0.5.0-1

The packages in the `system_fingerprint` repository were released into the `humble` distro by running `/usr/bin/bloom-release system_fingerprint -r humble` on `Wed, 21 Sep 2022 17:54:10 -0000`
...
## system_fingerprint (rolling) - 0.5.0-1

The packages in the `system_fingerprint` repository were released into the `rolling` distro by running `/usr/bin/bloom-release system_fingerprint -r rolling` on `Wed, 21 Sep 2022 17:51:00 -0000`
...
## system_fingerprint (galactic) - 0.5.0-1

The packages in the `system_fingerprint` repository were released into the `galactic` distro by running `/usr/bin/bloom-release system_fingerprint -r galactic` on `Wed, 21 Sep 2022 17:47:00 -0000`
...
## system_fingerprint (foxy) - 0.5.0-2
